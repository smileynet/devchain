...
export async function gameDesignSetup() {
  ...
  const inspirationGames = process.env.INSPIRATION_GAMES
    ...
    : await input({
        message:
          "Please name some existing games that should be used for inspiration:",
  ...
  console.log(
    chalk.cyanBright("I have received your input, get ready for the magic!")
  );
